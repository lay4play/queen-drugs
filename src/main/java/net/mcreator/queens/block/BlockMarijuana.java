...
public class BlockMarijuana extends ElementsQueens.ModElement {
	@GameRegistry.ObjectHolder("queens:marijuana")
	public static final Block block = null;
	public BlockMarijuana(ElementsQueens instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("queens:marijuana", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("marijuana");
			setRegistryName("marijuana");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemMarijuanaLeaf.block, (int) (1)));
		}
